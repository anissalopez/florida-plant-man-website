    ...
    <>
      <Grid item lg={4} xs={12} key="image1">
        ...
        {initialValues && !preview &&
          <img alt="previewimage" style={{ height: "200px", width: "200px" }} src={initialValues.image1} />
        }
        {preview &&
          <img alt="previewimage" style={{ height: "200px", width: "200px" }} src={preview.image1} />
        }
      ...
      <Grid item lg={4} xs={12} key="image2">
        ...
        />
        {initialValues && !preview &&
          <img alt="previewimage" style={{ height: "200px", width: "200px" }} src={initialValues.image2} />
        }
        {preview &&
          <img alt="previewimage" style={{ height: "200px", width: "200px" }} src={preview.image2} />
        }
      ...
      <Grid item lg={4} xs={12} key="image3">
        ...
        />
        {initialValues && !preview &&
          <img alt="previewimage" style={{ height: "200px", width: "200px" }} src={initialValues.image3} />
        }
        {preview &&
          <img alt="previewimage" style={{ height: "200px", width: "200px" }} src={preview.image3} />
        }
