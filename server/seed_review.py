...
if __name__ == '__main__':
    with app.app_context():
         ...
         def create_review_data():
            ...
            Review.query.delete()
            reviews = []
            review1 = Review(plant_id=1, rating=5, comment=comment1)
            review2 = Review(plant_id=1, rating=5, comment=comment2)
            review3 = Review(plant_id=2, rating=5, comment=comment3)
            review4 = Review(plant_id=3, rating=5, comment=comment4)
